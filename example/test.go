...
func main() {
	...
	// Если нужно ручное обновление (необязательно) или для точного первоначального получения данных,
	// например при ошибках совершить свои действия (повторить запрос или выйти из приложения с ошибкой)
	err := ph.Update()
	chkErr(err)
